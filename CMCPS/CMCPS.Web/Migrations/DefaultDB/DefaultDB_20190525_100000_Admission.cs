...
{
    [Migration(20190525100000)]
    public class DefaultDB_20190525_100000_Admission : AutoReversingMigration
    {
        public override void Up()
        {
            ...
            Create.Table("Admission")
                  ...
                  .WithColumn("Age").AsDecimal().Nullable()
                  .WithColumn("PinNumber").AsString().Nullable()
                  .WithColumn("UnitRegNumber").AsString().Nullable()
                  ...
                  .WithColumn("Status").AsBoolean().Nullable().WithDefaultValue(false)
