...
namespace CMCPS.Administration.Entities
{
    ...
    public sealed class UserRow : LoggingRow, IIdRow, INameRow, IIsActiveRow
    {
        ...
        [DisplayName("Designation"), ForeignKey("[dbo].[Designation]", "DesignationId"), LeftJoin("jDesignation")]
        ...
        [DisplayName("Designation"), Expression("jDesignation.DesignationName")]
        ...
        //{
        //    get { return (Designation?)Fields.Designation[this]; }
        //    set { Fields.Designation[this] = (Int32?)value; }
        //}
